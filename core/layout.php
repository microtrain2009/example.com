...
<!-- End sanitized content -->
      ...
      <meta charset="UTF-8">
      <title>Hello Welcome to MicroTrain2009</title>
    ...
    <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <a class="navbar-brand" href="#">MicroTrain2009 Blog</a>
      ...
      <div class="jumbotron">
            ...
            <p class="lead">Welcome to MicroTrain2009 Blog, Full Stack Web and Hybrid Mobile Applications Developer.</p>
            <hr class="my-4">
